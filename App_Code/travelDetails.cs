...
public class travelDetails
{
    ...
    public travelDetails(int id, string tripName, DateTime startDate, DateTime endDate, string country, string description, double expectedExpenses, string state, string userId)
    {
        travelDetailsId = id;
